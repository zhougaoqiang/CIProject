...
def split_csv_by_criteria(input_file, output_prefix):  
  ...
  exclude_cols = ['Title', 'authors']
  second_file_cols = ['bookId', 'Title']
  ...
  # Generate filenames
  first_file = f"{output_prefix}_no_title_author.csv"
  ...
  print(f"Split CSV completed. Files generated: {first_file}, {second_file}, {third_file}")
